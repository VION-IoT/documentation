...
Onboarding connects a physical device to the VION platform. The process is guided through the Dashboard wizard and involves running a provisioning script on the device via SSH.
