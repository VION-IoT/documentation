...
2026-08-24 · review · flashmq-replaces-nanomq · Five findings on the FlashMQ protocol update, all
...
excluded — a change that tightens a rule has to find every place the old rule is stated, not just
the place it is being tightened. The other four were STYLE.md rules the change simply did not
apply: migration history ("no broker restart is involved" — the reader never saw the restart),
