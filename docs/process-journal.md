...
2026-09-15 · brief · ipcbox-hal · The brief asked the I/O section to name the Mender artifact `ipcbox-hal`; artifacts-mender at origin/main carries no such artifact and STYLE.md § Things That Do Not Exist Yet forbids naming it, so the section says a Mender update without the name. (self)
