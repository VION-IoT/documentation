# Process journal, 2026-08-14 to 2026-08-25

The live window below the acted-on marker, rotated unread when this repo adopted the shared journal grammar; it predates that grammar.
