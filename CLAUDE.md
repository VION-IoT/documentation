...
- [`docs/process-journal/`](docs/process-journal/README.md) — friction log, one fragment per branch,
  in the grammar its [`README.md`](docs/process-journal/README.md) states.
